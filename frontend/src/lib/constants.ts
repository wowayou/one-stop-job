...
export const TOUR_STEPS: TourStep[] = [
  ...
  { target: "collect", title: "采集 / 导入岗位", body: "「采集」下拉收了 BOSS、beBee、海尔/海信招聘官网、CSV/XLSX 导入和公众号/元宝导入。所有新岗位都先进入聊天候选；返回 0 岗位时先看通知里的过滤、跳过或登录态原因。粘贴元宝回答或 mp.weixin 链接会抓正文并拆出多个岗位，被风控的文章可改为手动粘正文。" },
