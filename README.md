...
- **岗位池管理**：多来源采集（BOSS / 智联 / 公众号 / beBee / 海尔 / 北森门户 / CSV）、跨来源去重、状态流转、批量操作、软删除回收站
...
| **海尔招聘官网** | 采集按钮 | 抓 maker.haier.net 公开列表 JSON，年薪(万)自动换算月薪(K) |
| **北森门户（海信等）** | 采集按钮 | 一份解析接多家用北森 iTalent 的公司，新增一家只在 `beisen.portals` 加一行 |
