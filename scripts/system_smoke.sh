...
# 配置中和 + 环境隔离都在这一层（见 scripts/lib/testing_config.py 的 docstring）：
# 关掉 telegram / schedule.digest / automation / updates / ai.providers，
# 把 general.data_dir 指向临时目录，并清空密钥与个人上下文仓库路径。
