...
CONFIG_TOP_LEVEL_ALLOWLIST = {"opencli", "job_sources", "general", "research", "wechat", "bebee", "haier", "collect", "scoring", "followup", "ai", "ingest", "telegram", "schedule", "automation", "reach", "updates"}
